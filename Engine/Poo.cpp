...
void Poo::Init(int inX, int inY, int inVX, int inVY)
{
	x = inX;
	y = inY;
	vx = inVX;
...
void Poo::consumtion(int dudex, int dudey, int dudeH, int dudeW)
{
	const int duderight = dudex + dudeW;
	const int dudebottom = dudey + dudeH;
